...
public class FastHessian implements Serializable {
	...
	private SURFIPointList mInterestPoints;
	...
	public SURFIPointList getIPoints(int imageID, IntegralImage image){
		if ( mInterestPoints == null || mRecalculateInterestPoints ) {
//			mInterestPoints = new LinkedList<SURFInterestPoint>();
			mInterestPoints = new SURFIPointList();
			int count = 0;
			buildResponseMap();
				    	...
				    	for (int c = 0; c < t.getWidth(); c++) {
				    		if (isExtremum(r, c, t, m, b)) {
				    			...
				    			if (point != null) {
				    				...
				    				mInterestPoints.add(count, point);
//				    				System.out.println("mInterestPoints.size=" + mInterestPoints.size());
			...
			mInterestPoints.tailPosition = count;
//			System.out.println("mInterestPoints.listSize=" + mInterestPoints.listSize);
		}
